...
yāya chindati attānaṃ, bālo dubbhāsitaṃ bhaṇaṃ. %\hfill\textcolor{gray}{\footnotesize 1}
...
vicināti mukhena so kaliṃ, kalinā tena sukhaṃ na vindati. %\hfill\textcolor{gray}{\footnotesize 2}
...
ayam eva mahattaro kali, yo sugatesu manaṃ padosaye. %\hfill\textcolor{gray}{\footnotesize 3}
...
yam ariyagarahī nirayaṃ upeti, vācaṃ manañ ca paṇidhāya pāpakaṃ. %\hfill\textcolor{gray}{\footnotesize 4}
...
ubho pi te pecca samā bhavanti, nihīnakammā manujā parattha. %\hfill\textcolor{gray}{\footnotesize 5}
...
tam eva bālaṃ pacceti pāpaṃ, sukhumo rajo paṭivātaṃ va khitto. %\hfill\textcolor{gray}{\footnotesize 6}
...
asaddho kadariyo avadaññū, macchari pesuṇiyaṃ anuyutto. %\hfill\textcolor{gray}{\footnotesize 7}
...
\item 这里，在第一颂中，先说由被指认为「各种\footnote{guṇa 有「各种」的意思，见\textbf{犀牛角经}第 50 颂的注。}」故，或由多次转起故，贪本身即\textbf{各种贪}，即渴爱的同义语。\textbf{不慷慨}\footnote{义注将「慷慨」解作「知语」，见\textbf{摩伽经}第 492 颂的注。}，即不知语，甚至不接受世尊的教诫。\textbf{悭吝}，即以五种悭吝。\textbf{从事于诽谤}，即欲分裂上首弟子。其余自明。
...
purisanta kalī avajāta, mā bahubhāṇ’idha nerayiko’si. %\hfill\textcolor{gray}{\footnotesize 8}
...
bahūni duccaritāni caritvā, gacchasi kho papataṃ cirarattaṃ. %\hfill\textcolor{gray}{\footnotesize 9}
...
dukkhaṃ mando paraloke, attani passati kibbisakārī. %\hfill\textcolor{gray}{\footnotesize 10}
...
atha tatta ayo guḷasannibhaṃ, bhojanam atthi tathā patirūpaṃ. %\hfill\textcolor{gray}{\footnotesize 11}
...
aṅgāre santhate sayanti, ginisampajjalitaṃ pavisanti. %\hfill\textcolor{gray}{\footnotesize 12}
...
andhaṃ va timisam āyanti, taṃ vitatañ hi yathā mahikāyo. %\hfill\textcolor{gray}{\footnotesize 13}
...
paccanti hi tāsu cirarattaṃ, agginisamāsu samuppilavāte. %\hfill\textcolor{gray}{\footnotesize 14}
...
yaṃ yaṃ disakaṃ adhiseti, tattha kilissati samphusamāno. %\hfill\textcolor{gray}{\footnotesize 15}
...
gantuṃ na hi tīram ap’atthi, sabbasamā hi samantakapallā. %\hfill\textcolor{gray}{\footnotesize 16}
...
jivhaṃ balisena gahetvā, ārajayārajayā vihananti. %\hfill\textcolor{gray}{\footnotesize 17}
...
tattha mandā papatanti, pāpakarā pāpāni karitvā. %\hfill\textcolor{gray}{\footnotesize 18}
...
soṇā siṅgālā paṭigiddhā, kulalā vāyasā ca vitudanti. %\hfill\textcolor{gray}{\footnotesize 19}
...
tasmā idha jīvitasese, kiccakaro siyā naro na cappamajje. %\hfill\textcolor{gray}{\footnotesize 20}
...
nahutāni hi koṭiyo pañca bhavanti, dvādasa koṭisatāni pun’aññā. %\hfill\textcolor{gray}{\footnotesize 21}
...
tasmā suci-pesala-sādhuguṇesu, vācaṃ manaṃ satataṃ parirakkhe” ti. %\hfill\textcolor{gray}{\footnotesize 22}

\begin{center}\vspace{1em}瞿迦梨经第十\\Kokālikasuttaṃ dasamaṃ.\end{center}