...
\begin{enumerate}\item \textbf{无病}，即涅槃。\textbf{省思已受用}，省察四资具已受用，或省思世间为「五蕴、十二处、十八界」已，以「无常、苦、无我」之智受用。\textbf{住法者}，即住于四谛法者。\textbf{不入诸数}，即不入「人、天」等之数。其余自明。\end{enumerate}
