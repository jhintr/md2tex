...
\begin{center}Parābhava Sutta\end{center}\vspace{1em}
...
\subsection\*{\textbf{91} \textcolor{gray}{\footnotesize 〔91〕}}

\textbf{「我们问问衰败之人！乔达摩！\\}
\textbf{「前来问您，何为衰败者之因？」}

“Parābhavantaṃ purisaṃ, mayaṃ pucchāma Gotama;\\
bhavantaṃ puṭṭhum āgamma, kiṃ parābhavato mukhaṃ”. %\hfill\textcolor{gray}{\footnotesize 1}
...
\subsection\*{\textbf{92} \textcolor{gray}{\footnotesize 〔92〕}}

\textbf{「兴盛易知，衰败易知，\\}
\textbf{「爱法者兴盛，厌法者衰败。」}

“Suvijāno bhavaṃ hoti, suvijāno parābhavo;\\
dhammakāmo bhavaṃ hoti, dhammadessī parābhavo”. %\hfill\textcolor{gray}{\footnotesize 2}
...
\subsection\*{\textbf{93} \textcolor{gray}{\footnotesize 〔93〕}}

\textbf{「我们了知了这点，这是第一种衰败，\\}
\textbf{「世尊！请说说何为衰败者的第二因？」}

“Iti h’etaṃ vijānāma, paṭhamo so parābhavo;\\
dutiyaṃ Bhagavā brūhi, kiṃ parābhavato mukhaṃ”. %\hfill\textcolor{gray}{\footnotesize 3}
...
\subsection\*{\textbf{94} \textcolor{gray}{\footnotesize 〔94〕}}

\textbf{「他喜爱不善人，不去喜爱善人，\\}
\textbf{「赞许不善人的法，这是衰败者之因。」}

“Asant’assa piyā honti, sante na kurute piyaṃ;\\
asataṃ dhammaṃ roceti, taṃ parābhavato mukhaṃ”. %\hfill\textcolor{gray}{\footnotesize 4}
...
\subsection\*{\textbf{95} \textcolor{gray}{\footnotesize 〔95〕}}

\textbf{「我们了知了这点，这是第二种衰败，\\}
\textbf{「世尊！请说说何为衰败者的第三因？」}

“Iti h’etaṃ vijānāma, dutiyo so parābhavo;\\
tatiyaṃ Bhagavā brūhi, kiṃ parābhavato mukhaṃ”. %\hfill\textcolor{gray}{\footnotesize 5}

\subsection\*{\textbf{96} \textcolor{gray}{\footnotesize 〔96〕}}

\textbf{「若人惯于睡眠、惯于集会而不奋起，\\}
\textbf{「懒惰，现忿怒相，这是衰败者之因。」}

“Niddāsīlī sabhāsīlī, anuṭṭhātā ca yo naro;\\
alaso kodhapaññāṇo, taṃ parābhavato mukhaṃ”. %\hfill\textcolor{gray}{\footnotesize 6}
...
\subsection\*{\textbf{97} \textcolor{gray}{\footnotesize 〔97〕}}

\textbf{「我们了知了这点，这是第三种衰败，\\}
\textbf{「世尊！请说说何为衰败者的第四因？」}

“Iti h’etaṃ vijānāma, tatiyo so parābhavo;\\
catutthaṃ Bhagavā brūhi, kiṃ parābhavato mukhaṃ”. %\hfill\textcolor{gray}{\footnotesize 7}

\subsection\*{\textbf{98} \textcolor{gray}{\footnotesize 〔98〕}}

\textbf{「若对年老、青春已逝的父母，\\}
\textbf{「堪能却不赡养，这是衰败者之因。」}

“Yo mātaraṃ pitaraṃ vā, jiṇṇakaṃ gatayobbanaṃ;\\
pahu santo na bharati, taṃ parābhavato mukhaṃ”. %\hfill\textcolor{gray}{\footnotesize 8}
...
\subsection\*{\textbf{99} \textcolor{gray}{\footnotesize 〔99〕}}

\textbf{「我们了知了这点，这是第四种衰败，\\}
\textbf{「世尊！请说说何为衰败者的第五因？」}

“Iti h’etaṃ vijānāma, catuttho so parābhavo;\\
pañcamaṃ Bhagavā brūhi, kiṃ parābhavato mukhaṃ”. %\hfill\textcolor{gray}{\footnotesize 9}

\subsection\*{\textbf{100} \textcolor{gray}{\footnotesize 〔100〕}}

\textbf{「若对婆罗门、沙门或其他的乞食者\\}
\textbf{「以妄语欺骗，这是衰败者之因。」}

“Yo brāhmaṇaṃ samaṇaṃ vā, aññaṃ vā pi vanibbakaṃ;\\
musāvādena vañceti, taṃ parābhavato mukhaṃ”. %\hfill\textcolor{gray}{\footnotesize 10}
...
\subsection\*{\textbf{101} \textcolor{gray}{\footnotesize 〔101〕}}

\textbf{「我们了知了这点，这是第五种衰败，\\}
\textbf{「世尊！请说说何为衰败者的第六因？」}

“Iti h’etaṃ vijānāma, pañcamo so parābhavo;\\
chaṭṭhamaṃ Bhagavā brūhi, kiṃ parābhavato mukhaṃ”. %\hfill\textcolor{gray}{\footnotesize 11}

\subsection\*{\textbf{102} \textcolor{gray}{\footnotesize 〔102〕}}

\textbf{「那人饶有财富，有货币、有食物，\\}
\textbf{「独自享用美味，这是衰败者之因。」}

“Pahūtavitto puriso, sahirañño sabhojano;\\
eko bhuñjati sādūni, taṃ parābhavato mukhaṃ”. %\hfill\textcolor{gray}{\footnotesize 12}
...
\subsection\*{\textbf{103} \textcolor{gray}{\footnotesize 〔103〕}}

\textbf{「我们了知了这点，这是第六种衰败，\\}
\textbf{「世尊！请说说何为衰败者的第七因？」}

“Iti h’etaṃ vijānāma, chaṭṭhamo so parābhavo;\\
sattamaṃ Bhagavā brūhi, kiṃ parābhavato mukhaṃ”. %\hfill\textcolor{gray}{\footnotesize 13}

\subsection\*{\textbf{104} \textcolor{gray}{\footnotesize 〔104〕}}

\textbf{「若人以出身为傲，以财产为傲，以种姓为傲，\\}
\textbf{「鄙视自己的亲戚，这是衰败者之因。」}

“Jātitthaddho dhanatthaddho, gottatthaddho ca yo naro;\\
saññātiṃ atimaññeti, taṃ parābhavato mukhaṃ”. %\hfill\textcolor{gray}{\footnotesize 14}
...
\subsection\*{\textbf{105} \textcolor{gray}{\footnotesize 〔105〕}}

\textbf{「我们了知了这点，这是第七种衰败，\\}
\textbf{「世尊！请说说何为衰败者的第八因？」}

“Iti h’etaṃ vijānāma, sattamo so parābhavo;\\
aṭṭhamaṃ Bhagavā brūhi, kiṃ parābhavato mukhaṃ”. %\hfill\textcolor{gray}{\footnotesize 15}

\subsection\*{\textbf{106} \textcolor{gray}{\footnotesize 〔106〕}}

\textbf{「若人沉湎女人，嗜酒，嗜赌，\\}
\textbf{「倾尽所有，这是衰败者之因。」}

“Itthidhutto surādhutto, akkhadhutto ca yo naro;\\
laddhaṃ laddhaṃ vināseti, taṃ parābhavato mukhaṃ”. %\hfill\textcolor{gray}{\footnotesize 16}
...
\subsection\*{\textbf{107} \textcolor{gray}{\footnotesize 〔107〕}}

\textbf{「我们了知了这点，这是第八种衰败，\\}
\textbf{「世尊！请说说何为衰败者的第九因？」}

“Iti h’etaṃ vijānāma, aṭṭhamo so parābhavo;\\
navamaṃ Bhagavā brūhi, kiṃ parābhavato mukhaṃ”. %\hfill\textcolor{gray}{\footnotesize 17}

\subsection\*{\textbf{108} \textcolor{gray}{\footnotesize 〔108〕}}

\textbf{「不满于自身的妻妾，混迹于娼妓，\\}
\textbf{「混迹于他人的妻妾，这是衰败者之因。」}

“Sehi dārehi asantuṭṭho, vesiyāsu padussati;\\
dussati paradāresu, taṃ parābhavato mukhaṃ”. %\hfill\textcolor{gray}{\footnotesize 18}
...
\subsection\*{\textbf{109} \textcolor{gray}{\footnotesize 〔109〕}}

\textbf{「我们了知了这点，这是第九种衰败，\\}
\textbf{「世尊！请说说何为衰败者的第十因？」}

“Iti h’etaṃ vijānāma, navamo so parābhavo;\\
dasamaṃ Bhagavā brūhi, kiṃ parābhavato mukhaṃ”. %\hfill\textcolor{gray}{\footnotesize 19}

\subsection\*{\textbf{110} \textcolor{gray}{\footnotesize 〔110〕}}

\textbf{「青春已过的男人，带回乳房如小果者，\\}
\textbf{「出于对她的嫉妒而无法入睡，这是衰败者之因。」}

“Atītayobbano poso, āneti timbarutthaniṃ;\\
tassā issā na supati, taṃ parābhavato mukhaṃ”. %\hfill\textcolor{gray}{\footnotesize 20}
...
\subsection\*{\textbf{111} \textcolor{gray}{\footnotesize 〔111〕}}

\textbf{「我们了知了这点，这是第十种衰败，\\}
\textbf{「世尊！请说说何为衰败者的第十一因？」}

“Iti h’etaṃ vijānāma, dasamo so parābhavo;\\
ekādasamaṃ Bhagavā brūhi, kiṃ parābhavato mukhaṃ”. %\hfill\textcolor{gray}{\footnotesize 21}

\subsection\*{\textbf{112} \textcolor{gray}{\footnotesize 〔112〕}}

\textbf{「对上瘾、挥霍的女人，或对这样的男人，\\}
\textbf{「他委以权柄，这是衰败者之因。」}

“Itthiṃ soṇḍiṃ vikiraṇiṃ, purisaṃ vā pi tādisaṃ;\\
issariyasmiṃ ṭhapeti, taṃ parābhavato mukhaṃ”. %\hfill\textcolor{gray}{\footnotesize 22}
...
\subsection\*{\textbf{113} \textcolor{gray}{\footnotesize 〔113〕}}

\textbf{「我们了知了这点，这是第十一种衰败，\\}
\textbf{「世尊！请说说何为衰败者的第十二因？」}

“Iti h’etaṃ vijānāma, ekādasamo so parābhavo;\\
dvādasamaṃ Bhagavā brūhi, kiṃ parābhavato mukhaṃ”. %\hfill\textcolor{gray}{\footnotesize 23}

\subsection\*{\textbf{114} \textcolor{gray}{\footnotesize 〔114〕}}

\textbf{「薄财而多爱，生于刹帝利家族，\\}
\textbf{「且希求王位，这是衰败者之因。}

“Appabhogo mahātaṇho, khattiye jāyate kule;\\
so ca rajjaṃ patthayati, taṃ parābhavato mukhaṃ. %\hfill\textcolor{gray}{\footnotesize 24}
...
\subsection\*{\textbf{115} \textcolor{gray}{\footnotesize 〔115〕}}

\textbf{「智者省察了世间的这些衰败，\\}
\textbf{「圣者具足知见，追随吉祥的世间。」}

Ete parābhave loke, paṇḍito samavekkhiya;\\
ariyo dassanasampanno, sa lokaṃ bhajate sivan” ti. %\hfill\textcolor{gray}{\footnotesize 25}
...
\begin{center}\vspace{1em}衰败经第六\\Parābhavasuttaṃ chaṭṭhaṃ.\end{center}

%\begin{flushright}癸卯大寒二稿\end{flushright}