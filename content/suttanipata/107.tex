...
\subsection\*{\textbf{116} \textcolor{gray}{\footnotesize 〔116〕}}
...
\subsection\*{\textbf{117} \textcolor{gray}{\footnotesize 〔117〕}}
...
\subsection\*{\textbf{118} \textcolor{gray}{\footnotesize 〔118〕}}
...
\subsection\*{\textbf{119} \textcolor{gray}{\footnotesize 〔119〕}}
...
\subsection\*{\textbf{120} \textcolor{gray}{\footnotesize 〔120〕}}
...
\subsection\*{\textbf{121} \textcolor{gray}{\footnotesize 〔121〕}}
...
\subsection\*{\textbf{122} \textcolor{gray}{\footnotesize 〔122〕}}
...
\subsection\*{\textbf{123} \textcolor{gray}{\footnotesize 〔123〕}}
...
\subsection\*{\textbf{124} \textcolor{gray}{\footnotesize 〔124〕}}
...
\subsection\*{\textbf{125} \textcolor{gray}{\footnotesize 〔125〕}}
...
\subsection\*{\textbf{126} \textcolor{gray}{\footnotesize 〔126〕}}
...
\subsection\*{\textbf{127} \textcolor{gray}{\footnotesize 〔127〕}}
...
\subsection\*{\textbf{128} \textcolor{gray}{\footnotesize 〔128〕}}
...
\subsection\*{\textbf{129} \textcolor{gray}{\footnotesize 〔129〕}}
...
\subsection\*{\textbf{130} \textcolor{gray}{\footnotesize 〔130〕}}
...
\subsection\*{\textbf{131} \textcolor{gray}{\footnotesize 〔131〕}}

\textbf{若于此出言不善，以愚弄裹挟\footnote{以愚弄裹挟：原应译作「被愚痴裹挟」，这里据义注对此句的解释而作此译，且于上下文更觉通顺。}，\\}
\textbf{企求某物，当知他是贱民。}
...
\subsection\*{\textbf{132} \textcolor{gray}{\footnotesize 〔132〕}}
...
\subsection\*{\textbf{133} \textcolor{gray}{\footnotesize 〔133〕}}
...
\subsection\*{\textbf{134} \textcolor{gray}{\footnotesize 〔134〕}}
...
\subsection\*{\textbf{135} \textcolor{gray}{\footnotesize 〔135〕}}
...
\subsection\*{\textbf{136} \textcolor{gray}{\footnotesize 〔136〕}}
...
\subsection\*{\textbf{137} \textcolor{gray}{\footnotesize 〔137〕}}
...
\begin{enumerate}\item 现在，为了以例子成就此义，说了以下三颂，其中二颂各四句、一为六句。其义为：我所说的「不由出生而成贱民」等，\textbf{你们也可以此了知，好比我的这例子}，你们也可以此方式了知，即是说以我的方式、以普遍而举此例。那么是什么例子？即「旃陀罗之子、贱民……转生到梵界」。
...
\subsection\*{\textbf{138} \textcolor{gray}{\footnotesize 〔138〕}}
...
\subsection\*{\textbf{139} \textcolor{gray}{\footnotesize 〔139〕}}
...
\item 从此以后，整个阎浮提的刹帝利、婆罗门、在家人、出家人等都前来侍奉摩登伽智者。他在寿尽身坏后，便投生到梵界。因此世尊说「你们也可以此了知……转生到梵界」。\end{enumerate}

\subsection\*{\textbf{140} \textcolor{gray}{\footnotesize 〔140〕}}
...
\subsection\*{\textbf{141} \textcolor{gray}{\footnotesize 〔141〕}}
