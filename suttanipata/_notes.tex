...
\begin{itemize}
    ...
    \item 行文。对正文中的偈颂，一般将两句置于一行，这样便于调整译文中词序，只有少数例外，才会更改行间的语序。随后给出义注，并对义注的段落编号。为减少篇幅，这里未附巴利原文，需对读者可查看线上版本。
    ...
    \item 线上版本及旧版勘误，请至 \url{https://ehipassa.org/khuddaka/suttanipata/}。
\end{itemize}