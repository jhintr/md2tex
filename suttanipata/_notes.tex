...
\begin{itemize}
    ...
    \item 偈颂编号。两种英译均按 PTS 本，这里为与义注保持一致，而按 CST 本，但 CST 本的\textbf{经集}有两处 274 颂，相应的\textbf{第一义光}则为 274～275 颂，所以这里采用第一义光的编号，并附以 PTS 之有差异者。
    \item 行文。对正文中的偈颂，一般将两句置于一行，这样便于调整译文中词序，只有少数例外，才会更改行间的语序。随后给出义注，并对义注的段落编号。为减少篇幅，此版未附巴利原文，有需求者自可查看线上版本。
    ...
    \item 订讹。线上版本及勘误，可访问 \url{https://ehipassa.org/khuddaka/suttanipata/}。
\end{itemize}